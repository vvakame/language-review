...
var ViolationView = (function (_super) {
    ...
    ViolationView.prototype.tooltipShow = function () {
        this.operateTooltip(function (tooltip) { return tooltip.show(); });
    };
    ViolationView.prototype.tooltipHide = function () {
        this.operateTooltip(function (tooltip) { return tooltip.hide(); });
    };
    ViolationView.prototype.tooltipDestroy = function () {
        this.operateTooltip(function (tooltip) { return tooltip.destroy(); });
    };
