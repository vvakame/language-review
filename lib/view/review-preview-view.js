...
var ReVIEWPreviewView = (function (_super) {
    ...
    function ReVIEWPreviewView(params) {
        ...
        if (this.editorId) {
            ...
            this.file = new pathwatcher_1.File(params.filePath);
            this.runner = new review_runner_1.default({ file: this.file });
            this.handleEvents();
        }
    }
    ...
    ReVIEWPreviewView.prototype.adjustFontSize = function (fontSize) {
        if (fontSize === void 0) { fontSize = atom.config.get("editor.fontSize"); }
        this.jq.find("pre").css("font-size", fontSize + 2);
        this.jq.find(".lead").css("font-size", Math.ceil(fontSize * 1.4));
